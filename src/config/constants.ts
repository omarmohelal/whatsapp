...
- PayPal / Crypto / Binance / Credit Card: الأدمن يبعت التفاصيل

بعد التحويل ابعت سكرين الدفع. لو بيانات الطلب لسه ناقصة ابعتها في نفس الرسالة.`,
...
export const LEAGUE_SKIN_GIFT_REPLY = `تمام ❤️ ابعتلي:
- Riot ID
- السيرفر
- اسم السكن أو صورته

هدايا League لازم إضافة صديق الأول، وبعد قبول الإضافة بنستنى 7 أيام حسب نظام Riot.
بعد ما تبعت التفاصيل أقولك الدفع والخطوة الجاية.`;
...
املأ الفورم باللي تعرفه بوضوح:
- اللعبة + السيرفر / Region
- الرانك واللفل
- عدد السكينات / الأبطال / العملات
- أهم السكينات أو الحاجات النادرة
- صور واضحة أو فيديو لو التفاصيل كتير
- السعر المطلوب

في الـ Title اكتب ملخص سريع يشد العميل، مثال:
EUNE | Plat | 379 Skins | Ahen Graveknight Mordekaiser | First Mail + Full Access | Safe & Clean Account

مهم جدًا:
- شيل 2FA وأي رقم أو Recovery Email قبل التسليم.
- السعر خليه مناسب ومنافس عشان يتباع أسرع.
- لو مش عارف خانة في الفورم سيبها أو اكتب "مش عارف"، والأدمن يراجعها.

بعد ما تبعت الفورم، الأدمن هيراجع الأكونت ويكلمك ❤️`;
...
- السيرفر / Region
- الرانك أو البادجات
- أهم السكينات/الشخصيات اللي تهمك
- الميزانية

الأدمن هيراجع المتاح ويرشحلك أنسب حاجة حسب الميزانية ❤️`;
...
export const AI_FALLBACK_REPLY =
  'مش عايز أديك معلومة غلط ❤️ ابعت اسم اللعبة والخدمة المطلوبة في رسالة واحدة، والأدمن هيراجعها معاك.';

export const GEMINI_MISSING_KEY_REPLY = AI_FALLBACK_REPLY;

export const UNRELATED_REPLY =
  'أقدر أساعدك في خدمات TheNexus بس ❤️ شحن، جيفت/سكن، أو بيع وشراء أكونتات. ابعت الخدمة اللي محتاجها.';
...
export const ACCOUNT_SELLING_HELP_REPLY = `ولا يهمك ❤️ الفورم بتاع عرض الأكونت محتاج منك الأساسيات بس:
...
لو خانة مش عارفها سيبها أو اكتب "مش عارف".
ابعتلي اسم الخانة اللي واقف عندها وأنا أشرحها لك ببساطة.`;

export const PAYMENT_PROOF_REPLY = `تمام وصلني منك ❤️
لو بيانات الطلب لسه ناقصة ابعتها في رسالة واحدة: اسم اللعبة + الخدمة المطلوبة + ID/Username.
الأدمن هيراجع الدفع ويأكدلك.`;

export const DELAY_REPLY = `حقك علينا ❤️ ابعت رقم الطلب أو سكرين الدفع واسم اللعبة، والأدمن هيتابع حالة الشحن فورًا.`;

export const COMPLAINT_REPLY = `آسفين على أي مشكلة ❤️ ابعت تفاصيل اللي حصل وسكرين لو موجود، والأدمن هيراجعها معاك.`;


export const ORDER_COMPLETED_REVIEW_REPLY = `مبروك عليك الطلب ❤️
لو الخدمة وصلت تمام، رأيك أو Feedback بسيط بيفرق معانا جدًا 🙏`;
