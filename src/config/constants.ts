...
بعد التحويل ابعت سكرين الدفع + اسم اللعبة + بيانات الطلب، والأدمن هيأكد ويفعل الطلب.`,
...
- Riot ID
- السيرفر
- اسم السكن أو صورة السكن
- طريقة الدفع

هدايا League بتحتاج إضافة صديق، وبعد قبول الإضافة بننتظر 7 أيام حسب نظام Riot قبل إرسال الهدية.`;
...
export const ACCOUNT_LISTING_REPLY = `السلام عليكم 👋
تمام، نقدر نعرض الأكونت بتاعك بسهولة، بس محتاجين منك تملى الفورم ده:

https://www.thenexus.ink/

جوا الفورم هتلاقي كل المعلومات اللي محتاجينها عشان نعرض الأكونت بسرعة، زي:
- عدد الـ Blue Essence
- الرانك الحالي
- عدد السكينات
- السيرفر / Region

كمان هتكتب Title بسيط للأكونت يدي فكرة سريعة للعميل ويشجعه يفتح الـ Description.
مثال:
EUNE | Plat | 379 Skins | Ahen Graveknight Mordekaiser | First Mail + Full Access | Safe & Clean Account

بالنسبة للـ Description:
- لو الأكونت عليه سكينات كتير ومش كفاية 5 صور، ارفع باقي الصور أو فيديو على Imgur، ولو الموقع مش فاتح استخدم VPN.
- اكتب التفاصيل الأساسية بوضوح: اللفل، الرانك الحالي وأعلى رانك وصلت له، عدد السكينات، وأهم السكينات المميزة.

بالنسبة للسعر:
حاول يكون السعر مناسب ومنافس، لأن عندنا أكتر من 100 أكونت معروضين. لو السعر مبالغ فيه، غالبًا العميل هيختار أكونت تاني أقرب للقيمة.

مهم جدًا:
- شيل أي حماية على الأكونت أو الإيميل زي 2FA.
- شيل أي رقم أو Recovery Email.
- اتأكد إن كل البيانات مكتوبة صح ومفيش أخطاء.
...
export const PAYMENT_PROOF_REPLY = `تمام وصلني منك، ابعتلي بيانات الطلب كاملة: اسم اللعبة، الـ ID/Username، والخدمة المطلوبة. والأدمن هيراجع الدفع ويأكدلك ❤️`;
