...
export const GREETING_REPLIES = [
  ...
  'أهلاً بيك يا فندم ❤️ نورتنا، قولّي محتاج شحن إيه؟',
  'منورنا ❤️ تحب شحن، RP، جيفت، ولا أكونت؟',
  'أهلاً وسهلاً ❤️ ابعت اسم اللعبة وأنا أظبطك.'
] as const;

export const MORNING_REPLIES = [
  'صباح النور ❤️ تحت أمرك، تحب نبدأ بإيه؟',
  'صباح الفل ❤️ ابعت اسم اللعبة أو الخدمة اللي محتاجها.',
  'صباح الجمال ❤️ قولّي محتاج شحن إيه؟'
] as const;

export const EVENING_REPLIES = [
  'مساء الفل ❤️ تحت أمرك، محتاج شحن ولا جيفت؟',
  'مساء النور ❤️ ابعت طلبك وأنا أساعدك فورًا.',
  'مساء الخير ❤️ قولّي اسم اللعبة وهنكمل.'
] as const;
...
لو حابب طريقة معينة قولّي وهأكدها لك.`,
  `تمام ❤️ طرق الدفع عندنا:
...
بعد ما تختار الطريقة ابعتلي وأكملك الخطوات.`,
  `أكيد ❤️ نقدر نستقبل الدفع عن طريق:
...
export const ACCOUNT_LISTING_REPLY = `تمام ❤️ فورم TheNexus ده مخصص لبيع الأكونتات فقط:
https://www.thenexus.ink/

علشان نقدر نراجع الأكونت ونسعره صح، املى الحاجات المهمة:
...
- فيديو أو صور كاملة للأكونت من الداخل عشان نعرف نقيمه
...
export const PAYMENT_PROOF_REPLY = `تمام ❤️ ابعت سكرين التحويل أو رقم العملية + اسم اللعبة والباقه، وهراجع الدفع وأكملك الطلب.`;
